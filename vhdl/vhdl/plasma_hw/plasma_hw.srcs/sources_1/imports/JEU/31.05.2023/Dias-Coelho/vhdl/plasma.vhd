...
architecture logic of plasma is
   ...
   signal gpio5_reg         : std_logic_vector(31 downto 0);
   signal gpio6_reg         : std_logic_vector(31 downto 0);
   signal gpio7_reg         : std_logic_vector(31 downto 0);
...
--   gpio0_out(23 downto 0) <= gpio0_reg(23 downto 0);
  ...
  opt_cache: if use_cache = '0' generate
   ...
   misc_proc: process(clk, reset, cpu_address, enable_misc,
      ...
      irq_mask_reg, irq_status, gpio0_reg,gpio1_reg,gpio2_reg,gpio3_reg,gpio4_reg,gpio5_reg,gpio6_reg,gpio7_reg, write_enable,
      cache_checking,
   ...
   begin
      ...
      when "010" =>         --misc
         ...
         when "10000" =>      --gpio5   
            cpu_data_r <= gpio5_reg;   
         when "10010" =>      --gpio6   
            cpu_data_r <= gpio6_reg;   
         when "10100" =>      --gpio7   
            cpu_data_r <= gpio7_reg;                                
         when "00101" =>      --gpioA
            cpu_data_r <= gpioA_in;
         when "00110" =>      --counter
      ...
      if reset = '1' then
         ...
         gpio0_reg <= ZERO;
         gpio1_reg <= "00000000000001011010001001000100";
         gpio2_reg <= "00000000000001011010000000001010";
         gpio3_reg <= ZERO;
         gpio4_reg <= "00000000000001011010000011001000";
         gpio5_reg <= "00000000000011001000001100100000";
         gpio6_reg <= "00000000000011001000001100100000"; 
         gpio7_reg <= "00000000000000101001010011011100";                          
         counter_reg <= ZERO;
         ...
         if cpu_pause = '0' then
            if enable_misc = '1' and write_enable = '1' then
               if cpu_address(8 downto 4) = "00001" then
                  ...
                  gpio5_reg <= gpio5_reg or cpu_data_w;       
               elsif cpu_address(8 downto 4) = "10001" then
                  gpio5_reg <= gpio5_reg and not cpu_data_w;                      
               elsif cpu_address(8 downto 4) = "10010" then
                  gpio6_reg <= gpio6_reg or cpu_data_w;       
               elsif cpu_address(8 downto 4) = "10011" then
                  gpio6_reg <= gpio6_reg and not cpu_data_w;                      
               elsif cpu_address(8 downto 4) = "10100" then
                  gpio7_reg <= gpio7_reg or cpu_data_w;       
               elsif cpu_address(8 downto 4) = "10101" then
                  gpio7_reg <= gpio7_reg and not cpu_data_w;                                                                           
               end if;
            end if;
         end if;
